...
- patch `0x620` body `0x61a`: `466c6173682054797065204572726f` -> `7f207eff7dffddfedefadff60232c4`.
- expected host READ BUFFER id=01 offset if admitted: `0x182b5`.

## Outputs

- candidate: `references/firmware/extracted/liteon-full-currentboot-ld5m-base-mutated-all-helper-final-branch-delay-poc-candidate.json`
- mutated plaintext tail: `references/firmware/extracted/profile-tail-mutation-candidates/helper-final-branch-delay-poc/ef130045-mutated-string-plain.bin`
- mutated currentboot payload: `references/firmware/extracted/profile-tail-mutation-candidates/helper-final-branch-delay-poc/ef130045-mutated-string-currentboot-payload.bin`

...
- device: `/dev/sg0`
- timestamp UTC: `2026-05-04T17:20:54.593258+00:00`
- profile: `core`
- cycles: `3`
...
|---|---:|---|---|---:|
| `baseline-test-unit-ready` | 1 | `empty` | `00/00/00` x3 | 1 |
| `getcfg-all-0000` | 1 | `ef4fbc3f6980` | - | 2 |
| `getcfg-current-0000` | 1 | `3f2298adc6ed` | - | 3 |
| `getcfg-current-0000-len16` | 1 | `44f1fee3c03d` | - | 2 |
| `getcfg-current-0000-len64` | 1 | `3f2298adc6ed` | - | 2 |
| `getcfg-current-0001` | 1 | `5415d6eda815` | - | 2 |
| `getcfg-current-0010` | 1 | `afeea43d7f88` | - | 2 |
| `getcfg-current-0020` | 1 | `9d095d24d858` | - | 2 |
| `getcfg-current-0100` | 1 | `39bacb767e0e` | - | 2 |
| `getcfg-one-0000` | 1 | `17c42afea436` | - | 2 |
| `getevent-busy` | 1 | `ddd1faf2c467` | - | 2 |
| `getevent-external` | 1 | `d570c65860bc` | - | 2 |
| `getevent-media` | 1 | `b321489fa116` | - | 3 |
| `getevent-multihost` | 1 | `67de05f5172e` | - | 1 |
| `getevent-operational` | 1 | `67de05f5172e` | - | 2 |
| `getevent-power` | 1 | `25b2ea65b069` | - | 2 |
| `inquiry-extrainq-176` | 1 | `077fe3994e56` | - | 1 |
| `inquiry-extrainq-240` | 1 | `077fe3994e56` | - | 2 |
| `inquiry-standard-36` | 1 | `0ee0c5976aa0` | - | 1 |
...
| `modesense-cd-audio` | 1 | `1bbc802cd056` | - | 3 |
| `modesense-cd-device` | 1 | `6393bfc79af9` | - | 1 |
...
### getcfg-all-0000
- x2: `rec58-edge-a@- rec58-edge-b@- rec58-edge-c@- rec58-bridge-long@+0x7010 rec58b-ctrl-long@+0x738e rec60-a@- rec60-b@- rec60-c@- rec60-bridge-long@+0x74c0`
- x1: `rec58-edge-a@- rec58-edge-b@- rec58-edge-c@- rec58-bridge-long@+0x70d0 rec58b-ctrl-long@+0x738e rec60-a@- rec60-b@- rec60-c@- rec60-bridge-long@+0x74c0`

### getcfg-current-0000
- x1: `rec58-edge-a@- rec58-edge-b@- rec58-edge-c@- rec58-bridge-long@+0x7010 rec58b-ctrl-long@+0x70c0 rec60-a@- rec60-b@- rec60-c@- rec60-bridge-long@+0x74c0`
- x1: `rec58-edge-a@- rec58-edge-b@- rec58-edge-c@- rec58-bridge-long@+0x70d0 rec58b-ctrl-long@+0x738e rec60-a@- rec60-b@- rec60-c@- rec60-bridge-long@+0x74c0`
- x1: `rec58-edge-a@- rec58-edge-b@- rec58-edge-c@- rec58-bridge-long@+0x7010 rec58b-ctrl-long@+0x738e rec60-a@- rec60-b@- rec60-c@- rec60-bridge-long@+0x74c0`

### getcfg-current-0000-len16
- x2: `rec58-edge-a@- rec58-edge-b@- rec58-edge-c@- rec58-bridge-long@+0x70d0 rec58b-ctrl-long@+0x738e rec60-a@- rec60-b@- rec60-c@- rec60-bridge-long@+0x74c0`
- x1: `rec58-edge-a@- rec58-edge-b@- rec58-edge-c@- rec58-bridge-long@+0x70d0 rec58b-ctrl-long@+0x7000 rec60-a@- rec60-b@- rec60-c@- rec60-bridge-long@+0x74c0`

### getcfg-current-0000-len64
- x2: `rec58-edge-a@- rec58-edge-b@- rec58-edge-c@- rec58-bridge-long@+0x7010 rec58b-ctrl-long@+0x738e rec60-a@- rec60-b@- rec60-c@- rec60-bridge-long@+0x74c0`
- x1: `rec58-edge-a@- rec58-edge-b@- rec58-edge-c@- rec58-bridge-long@+0x7050 rec58b-ctrl-long@+0x738e rec60-a@- rec60-b@- rec60-c@- rec60-bridge-long@+0x74c0`
...
### getcfg-one-0000
- x2: `rec58-edge-a@- rec58-edge-b@- rec58-edge-c@- rec58-bridge-long@+0x7050 rec58b-ctrl-long@+0x738e rec60-a@- rec60-b@- rec60-c@- rec60-bridge-long@+0x74c0`
- x1: `rec58-edge-a@- rec58-edge-b@- rec58-edge-c@- rec58-bridge-long@+0x7010 rec58b-ctrl-long@+0x738e rec60-a@- rec60-b@- rec60-c@- rec60-bridge-long@+0x74c0`
...
### getevent-media
- x1: `rec58-edge-a@- rec58-edge-b@- rec58-edge-c@- rec58-bridge-long@+0x70d0 rec58b-ctrl-long@+0x738e rec60-a@- rec60-b@- rec60-c@- rec60-bridge-long@-`
- x1: `rec58-edge-a@- rec58-edge-b@- rec58-edge-c@- rec58-bridge-long@+0x7010 rec58b-ctrl-long@+0x738e rec60-a@- rec60-b@- rec60-c@- rec60-bridge-long@+0x74c0`
- x1: `rec58-edge-a@- rec58-edge-b@- rec58-edge-c@- rec58-bridge-long@+0x70d0 rec58b-ctrl-long@+0x738e rec60-a@- rec60-b@- rec60-c@- rec60-bridge-long@+0x74c0`
...
- JSON: `references/evidence/live/drive3-normal-response-matrix-core-shuffled-20260504/summary.json`

...
- device: `/dev/sg0`
- timestamp UTC: `2026-05-04T17:18:22.587557+00:00`
- profile: `core`
- cycles: `1`
...
|---|---:|---|---|---:|
| `baseline-test-unit-ready` | 1 | `empty` | `00/00/00` x1 | 1 |
| `getcfg-all-0000` | 1 | `ef4fbc3f6980` | - | 1 |
| `getcfg-current-0000` | 1 | `3f2298adc6ed` | - | 1 |
| `getcfg-current-0000-len16` | 1 | `44f1fee3c03d` | - | 1 |
| `getcfg-current-0000-len64` | 1 | `3f2298adc6ed` | - | 1 |
| `getcfg-current-0001` | 1 | `5415d6eda815` | - | 1 |
| `getcfg-current-0010` | 1 | `afeea43d7f88` | - | 1 |
| `getcfg-current-0020` | 1 | `9d095d24d858` | - | 1 |
| `getcfg-current-0100` | 1 | `39bacb767e0e` | - | 1 |
| `getcfg-one-0000` | 1 | `17c42afea436` | - | 1 |
| `getevent-busy` | 1 | `b7fee44acb2c` | - | 1 |
| `getevent-external` | 1 | `9205fb2f4949` | - | 1 |
| `getevent-media` | 1 | `b321489fa116` | - | 1 |
| `getevent-multihost` | 1 | `67de05f5172e` | - | 1 |
| `getevent-operational` | 1 | `67de05f5172e` | - | 1 |
| `getevent-power` | 1 | `25b2ea65b069` | - | 1 |
| `inquiry-extrainq-176` | 1 | `077fe3994e56` | - | 1 |
| `inquiry-extrainq-240` | 1 | `077fe3994e56` | - | 1 |
| `inquiry-standard-36` | 1 | `0ee0c5976aa0` | - | 1 |
| `inquiry-standard-96` | 1 | `494fd1594d9d` | - | 1 |
| `modesense-all` | 1 | `17f2e6cb97b5` | - | 1 |
| `modesense-caching` | 1 | `ad6ad737bae6` | - | 1 |
| `modesense-capabilities` | 1 | `387e87799ddb` | - | 1 |
| `modesense-cd-audio` | 1 | `1bbc802cd056` | - | 1 |
| `modesense-cd-device` | 1 | `6393bfc79af9` | - | 1 |
| `modesense-fault-failure` | 1 | `empty` | `00/00/00` x1 | 1 |
| `modesense-power` | 1 | `3ef7fba3fd23` | - | 1 |
| `modesense-read-error` | 1 | `f94cadcc283b` | - | 1 |
| `request-sense` | 1 | `572aa2d495ba` | - | 1 |

## Interesting Window Layouts

## Raw Files

- JSON: `references/evidence/live/drive3-normal-response-matrix-core-20260504/summary.json`
